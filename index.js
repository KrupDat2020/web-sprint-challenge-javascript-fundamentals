...
CuboidMaker.prototype.volume = function(){
  return `the volume is equal to ${this.length} * ${this.width} * ${this.height}`;
}
...
CuboidMaker.prototype.surfaceArea = function() {
  return `The surface area is equal to 2 * ${this.length} * ${this.width} + ${this.length} * ${this.height} + ${this.width} * ${this.height}`;
}
...
surfaceArea() {
  return `The surface area is equal to 2 * ${this.length} * ${this.width} + ${this.length} * ${this.height} + ${this.
    width} * ${this.height}`;
}
